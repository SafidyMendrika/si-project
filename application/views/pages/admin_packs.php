...
<main style="margin-top: 58px">
    <div class="container pt-4">
        <div class="row">
            <div class="col-md-6">
            <?php foreach($pack as $element){ ?>
                <div style="box-shadow: 2px 2px 2px solid black;">
                    <h3><?= $element['label']; ?></h3>
                    <p>prix: <?= $element['price']; ?>Ar</p>
                    <p>remise: <?= $element['remise']; ?>%</p>
                </div>
                <br><br>
            <?php } ?>
            </div>
            <div class="col-md-6">
                <h1>Insertion de pack</h1>
                <form action="#" enctype="multipart/form-data">
                    <label for="nom">Nom:</label> <input type="text" name="nom" id="">
                    <br><br>
                    <label for="prix">Prix:</label> <input type="number" name="prix" id="" min="1">
                    <br><br>
                    <label for="remise">Remise:</label> <input type="number" name="remise" id="" min="1">
                    <br><br>
